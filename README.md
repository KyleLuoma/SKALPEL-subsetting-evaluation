...
python ./src/main.py --nl_sql perfect_table_subsetter-snails --no_subset_generation --nlsql_args model:gpt-4.1-nano --recover_previous
python ./src/main.py --nl_sql perfect_table_subsetter-snails --no_subset_generation --nlsql_args model:gpt-4.1 --recover_previous
python ./src/main.py --nl_sql perfect_table_subsetter-snails --no_subset_generation --nlsql_args model:llama3.3 --recover_previous
```
