\begin{table}
\caption{This table shows the Value Reference Problem (VRP) and Hidden Relation Problem (HRP) mean occurence percentages and sensitivities. Sensitivity (Sens.) is the proportion of a given problem occurence percentage (defined as realized problem over all instances where the problem might occur) to the percentage of all missing relations (\% MR, the mean count of missing relations over the count of required relations in a gold SQL query) or attributes (\% MA, the mean count of missing attributes over the count of required attributes in a gold SQL query) in the performance data.}
