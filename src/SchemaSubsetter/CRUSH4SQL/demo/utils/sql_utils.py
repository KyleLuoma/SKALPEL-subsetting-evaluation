...
from SchemaSubsetter.CRUSH4SQL.demo.utils.prompts import PROMPTS
...
#Skalpel mod: added generate_sql argument to prevent generating sql queries during phase 1 of eval.
def generate_sql(item, api_type, api_key, endpoint, api_version, prompting_type='base', fewshot_examples=[], generate_sql: bool = True):
