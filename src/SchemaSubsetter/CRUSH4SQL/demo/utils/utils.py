...
from SchemaSubsetter.CRUSH4SQL.demo.utils.openai_main import get_openai_embedding, get_hallucinated_segments
...
from SchemaSubsetter.CRUSH4SQL.demo.utils.sql_utils import generate_sql
...
# Skalpel mod: Added generate_sql_query argument to prevent sql query generation during phase I eval
def ndap_pipeline(question, api_type, api_key, endpoint, api_version, correct_txt_sql_pairs, generate_sql_query: bool = True):
